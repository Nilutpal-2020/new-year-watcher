...
const ShareBlock = () => {
    ...
    return (
        <section className="py-8">
            <div className="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 md:p-8 overflow-hidden group shadow-lg dark:shadow-none transition-colors">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-slate-600 dark:text-slate-400 text-sm max-w-md transition-colors">
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        ...
                        <div className="flex gap-2">
                            ...
                            <a
                                ...
                                className="bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 dark:hover:text-white p-3 rounded-xl transition-colors border border-slate-200 dark:border-slate-700"
                            ...
                            <button
                                ...
                                className="bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 dark:hover:text-white p-3 rounded-xl transition-colors border border-slate-200 dark:border-slate-700 group/insta"
                            ...
                            <button
                                onClick={handleCopy}
                                className="bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 dark:hover:text-white p-3 rounded-xl transition-colors border border-slate-200 dark:border-slate-700 relative"
